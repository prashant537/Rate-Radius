...
public class SendPassword extends AsyncTask<Void,Void,Void> {
    ...
    public SendPassword(Context context, String email, String subject, String message){
    ...
    protected Void doInBackground(Void... params) {
        ...
        session = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication("prashant1407055@nitp.ac.in","*P9810849673t#");
                    }
                });
        ...
        try {
            ...
            mm.setFrom(new InternetAddress("prashanttripathi537@gmail.com"));
